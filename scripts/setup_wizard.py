#!/usr/bin/env python3
"""
Debug AI - Interactive Setup Wizard
...
def configure_etl_paths(config):
    ...
    print("  This is where Debug AI will look for CREATE TABLE statements")
...
def write_config(config):
    ...
    with open(config_path, 'w') as f:
        f.write("# ============================================\n")
        f.write("# Debug AI - Database Configuration\n")
        f.write("# ============================================\n")
...
def configure_mcp_auto(mcp_path):
    ...
    print("\nWould you like me to automatically configure Debug AI for these tools?")
...
def show_mcp_manual_instructions(mcp_path):
    ...
    print("To use Debug AI with AI tools (Cursor, Claude Desktop, etc.):\n")
...
def main():
    """Main setup wizard."""
    print("\n" + "╔" + "═" * 68 + "╗")
    print("║" + " " * 20 + "Debug AI Setup Wizard" + " " * 27 + "║")
    print("╚" + "═" * 68 + "╝\n")
    
    print("This wizard will help you configure Debug AI for your database.")
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("\n✅ Setup complete! You're ready to use Debug AI.\n")
