...
**Mac / Linux:**
```bash
curl -fsSL https://raw.githubusercontent.com/oarbel11/debug_ai/main/install/install.sh | bash
```

**Windows (PowerShell):**
```powershell
irm https://raw.githubusercontent.com/oarbel11/debug_ai/main/install/install.ps1 | iex
```
...
Debug AI has two main features:
...
```bash
git clone https://github.com/oarbel11/debug_ai.git
cd debug_ai
python -m venv .venv
...
- Make sure you're in the `debug_ai` directory
